                        ...
                        <table class="table">
                            ...
                            <tbody class="text-center" style="background-color: #F8F8F8;">
                                <tr>
                                    ...
                                    <td>£{{$product_ask->ask}}</td>
                                </tr>
                                <tr>
                                    <td>Discount</td>
                                    <td>
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#exampdddleModalCenter" class="btn btn_dis_amount">
                                            +Add Discount
                                        </a>
                                        <button type="button" class="close close_discount" data-dismiss="alert">
                                ...
                                <tr>
                                    <td>Total</td>
                                    <input type="hidden" name="place_bid_input" class="place_bid_input" value="{{$product_ask->min_ask}}">
                                    <td class="grand_total">£{{$product_ask->ask}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="card border-0 shadow rounded-0">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 dd_0 p_r">
                                    @if(!Auth::user()->paymentPaypal)
                                        <a href="{{route('seller.paypal.checket_verification',$product->id)}}" class="btn btn-primary btn-lg">Paypal</a>
                                    @endif
                                </div>
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-dark rounded-0 border-0 mt-4 mb-5 btn-lg" style="width: 10rem;">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
