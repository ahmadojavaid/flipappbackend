							...
							<form method="post" action="{{route('seller.sell.payment_process')}}">
								...
								<div class="p-1 place-a-bid-current-highest">
									...
									<div class="row choose_size_first"  >
										<div class="col text-white text-center" >
											<p class="mb-0 d-inline " style=" font-weight: bold;">Current Highest Bid: £ {{$product_bid->high_bid}}</p> 
										</div>
									</div>
								...
								<div class="row pt-3 pb-1 ">
									<div class="col "> 
											<div class="form-group row">
												...
												<label for="staticBid" class="col-sm-3 col-form-label">SELLING AT:</label>
												<div class="col-sm-5">
													<input type="text" required="" autocomplete="off" name="bid" style="background: #969696; color: white;" value="{{$product_bid->high_bid}}" readonly="" class="form-control-plaintext place-a-bid-amount-text-field place_bid_input" id="staticBid"
								...
								<section class="p-2 place-a-bid-font-size" style="background-color: #F3F3F3;">
									...
									<div class="d-flex flex-row justify-content-between">
										<div class="p-2">
											<p>Payment Protection ({{@$setting->value}}%)</p>
									...
									<div class="d-flex flex-row justify-content-between">
										<div class="p-2">
											<p class="mb-0 font-weight-bold">Total you will be paid:</p>
										</div>
										<div class="p-2">
											<input type="hidden" name="total" class="total_hi">
											<p class="mb-0 font-weight-bold total_bid_dynamic_cal ">£ {{(float)$product_bid->high_bid + (float)$transaction_fee}} </p>
										</div>
									</div>
								...
								<div class="row pt-3 pb-2">
									<div class="col">
										<p>Choose a pament method for receive payment</p>
								...
								<div class="row">
									<div class="col text-center">
										<button type="submit" class="btn p-2 rounded-0 text-white bg-dark shadow-none place_bid_button" style="width: 10rem;border: 2px white solid;">Sell Now
										</button>
									</div>
								</div>
							</form>
