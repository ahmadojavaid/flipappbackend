						...
						<section class="pt-2 pb-2" style="background-color: #F8F8F8;">
							...
							<div class="row pt-3 pb-3">
								<div class="col text-center">
									...
									<button class="btn p-2 rounded-0 text-white bg-dark shadow-none" data-toggle="modal" data-target="#exampleModalCenter"
										   style="width: 5rem;border: 2px white solid;padding: 3px !important;">{{session('product_size_name')}}
									</button>
								</div>
							</div>
							<form method="post" action="{{route('seller.portfolio.save_place_ask')}}">
								@csrf
								...
								<section class="p-2 place-a-bid-font-size" style="background-color: #F3F3F3;">
									...
									<input type="hidden" name="product_size" value="{{session('product_size_id')}}"  class="product_size_model">
									<div>
										<hr class="m-0">
									</div>
									<div class="d-flex flex-row justify-content-between">
										...
										<div class="p-2">
											...
											<p class="mb-0 font-weight-bold total_ask_dynamic_cal "> </p>
										</div>
									</div>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<div class="text-center">
		        ...
		        <br>
		        <a id="btn-credit"  data-toggle="pill" href="{{(Auth::user()->paymentCreditCard) ? 'javascript:;' : '#credit_card_div'}}" role="tab" title="{{(Auth::user()->paymentCreditCard) ? 'Credit card is already added' : ''}}" aria-controls="pills-profile" aria-selected="false" style="background-color: #000000; color: white" class="btn">
		        	CREDIT CARD 
