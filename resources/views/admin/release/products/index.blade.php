...
@section('content')
    {{ Breadcrumbs::render('re-products') }}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right mt-3 mt-lg-0"> 
                            <a href="{{route('admin.release_product.create')}}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle mr-1"></i> Add Product</a>
                        </div>
                    </div><!-- end col-->
                </div> <!-- end row -->
            <!-- </div> end card-box -->
...
<script type="text/javascript">
	...
	processing: true,
	serverSide: true,
	ajax: "{{ route('admin.release_product.get_products') }}",
    "aaSorting": [],
	columns: [
