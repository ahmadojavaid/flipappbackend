...
<div class="card">
    <div class="card-body">
<form method="post" action="{{route('admin.product.store')}}" id="form_sub"  enctype="multipart/form-data">
		                			...
		                			<label for="exampleInputPassword1">Sizes</label>
		                            		<div class="row p-40">
					                            ...
					                            <!-- <div class="custom-control col-lg-1 custom-checkbox mb-2 " >
					                                <input type="checkbox" class=" size custom-control-input" value="s"  name="size[]"   id="autoSddfdfizingCheck">
					                                <label class="custom-control-label"  for="autoSddfdfizingCheck">S</label>
					                            </div>
					                            <div class="custom-control col-lg-1 custom-checkbox mb-2 " >
					                                <input type="checkbox" class=" size custom-control-input" value="m"  name="size[]"   id="autoSdfdfdfererizingCheck">
					                                <label class="custom-control-label"  for="autoSdfdfdfererizingCheck">M</label>
					                            </div>
					                            <div class="custom-control col-lg-1 custom-checkbox mb-2 " >
					                                <input type="checkbox" class=" size custom-control-input" value="l"  name="size[]"   id="autoSiztytytyingCheck">
					                           ...
					                           <!--  <div class="custom-control col-lg-1 custom-checkbox mb-2" >
					                                <input type="checkbox" class=" size custom-control-input" value="xl"  name="size[]"   id="autoSizDDDDingCheck">
					                                <label class="custom-control-label"  for="autoSizDDDDingCheck">XL</label>
					                            </div>
					                            <div class="custom-control col-lg-1 custom-checkbox mb-2">
					                                <input type="checkbox" class=" size custom-control-input" value="xxl" name="size[]"   id="aut333oSizingCheck">
