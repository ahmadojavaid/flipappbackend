...
class ProductController extends Controller
{
    ...
    public function getProducts(){
    	$products 	= Product::with('brandName','ProductSizes.productTypeSize')->where('product_status',1)->orderBy('created_at','desc')->get();
        // dd($products);
		return DataTables::of($products)
			...
			->addColumn('action',function($product){
				return view('admin.products.action-button',compact('product'))->render();
			})->make(true);
    }
    public function create(){
      ...
      //  dd($product_type->name);
    	return view('admin.products.add-product',compact('brands','product_type'));
    }
    ...
    public function edit($id){
        ...
        if($product){
            return view('admin.products.edit',compact('brands','product','product_type','product_sizes'));
        }
